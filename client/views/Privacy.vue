<template>
    ...
    <div class="container">
        ...
        <div class="container">
          <p> Pixelect built the Pixelect app as a Free app. This SERVICE is provided by Pixelect at no cost and is intended for use as is.
          </p>
          ...
          <p>The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which is accessible at Pixelect unless otherwise defined in this Privacy Policy.</p>

          <p class="subtitle"><strong>Information Collection and Use</strong></p> <p>For a better experience, while using our Service, I may require you to provide us with certain personally identifiable information, including but not limited to Facebook App Id, Uploaded photos. The information that I request is retained on your device and is not collected by me in any way</p>

          <p>The app does use third party services that may collect information used to identify you.</p>

          <p class="subtitle"><strong>Log Data</strong></p>

          <p> I want to inform you that whenever you use my Service, in a case of an error in the app I collect data and information (through third party products) on your phone called Log Data. This Log Data may include information such as your device Internet Protocol (“IP”) address, device name, operating system version, the configuration of the app when utilizing my Service, the time and date of your use of the Service, and other statistics.</p>

          <p class="subtitle"><strong>Cookies</strong></p>
          ...
          <p class="subtitle"><strong>Service Providers</strong></p>
          ...
          <p class="subtitle"><strong>Security</strong></p>
          ...
          <p class="subtitle"><strong>Links to Other Sites</strong></p>
          ...
          <p class="subtitle"><strong>Children’s Privacy</strong></p>
          ...
          <p class="subtitle"><strong>Changes to This Privacy Policy</strong></p>
